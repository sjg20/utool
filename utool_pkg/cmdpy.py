...
def get_board_config(board):
    ...
    config_path = os.path.join(hooks_bin, hostname, config_name)
    ...
    return parse_hook_config(config_path)
...
def get_qemu_command(board, args):
    ...
    # Expand variables
    qemu_extra_args = expand_variables(qemu_extra_args, env)
    qemu_kernel_args = expand_variables(qemu_kernel_args, env)
